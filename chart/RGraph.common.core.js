...
{if(obj&&obj.isRGraph){var co=obj.context;var ca=obj.canvas;}else if(typeof obj=='string'){var ca=document.getElementById(obj);var co=ca.getContext('2d');}else if(typeof obj.getContext==='function'){var ca=obj;var co=ca.getContext('2d');}else if(obj.toString().indexOf('CanvasRenderingContext2D')!=-1){var co=obj;var ca=obj.canvas;}
...
{id=typeof id==='object'?id.id:id;var tag=doc.getElementById(id);return[id,tag];};RG.Effects.updateCanvas=RG.Effects.UpdateCanvas=function(func)
...
{return ma.pow(ma.sin((frame/frames)*RG.HALFPI),5);};})(window,document);window.$p=function(v)
