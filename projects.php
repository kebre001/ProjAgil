...
<?php
	...
	$small = substr($result_proj['description'], 0, 250);
	if(strlen($result_proj['description']) > 250)
	{
		$small .= "...";;
	}
	...
	?>
		...
		echo 'Expired';
			...
			echo $interval->format('%a days')." left\n";
		            ...
		            <div class="desc"><p><?php echo $small;?></p></div>
	...
	if (mysql_num_rows($result)==0) { 
		...
		echo 'Click +Proj to create your first project';
		echo '</div>';
	 }
	?>
